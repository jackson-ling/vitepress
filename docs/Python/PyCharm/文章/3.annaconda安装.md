...
<h1 style="text-align: center; font-weight: bold;">annaconda 安装</h1>

---

<h3><span style = "color:red;font-weight:bold">温馨提醒：如果专业不是数据分析和机器学习、深度学习方向，可以不安装，使用 python 环境配置 pip 安装需要的包即可，annaconda 占用空间大（初始化安装后可以达到 10 个 G 多），且独立管理环境上有一定难度，衍生问题众多...</span></h3>

## 安装 conda

<h3>简介：annaconda 简单理解是一个环境管理器</h3>

<h3>点击下方链接开始下载 annaconda</h3>
...
<h4>只会删除环境中的包，但是不会删除 package 中的包</h4>
