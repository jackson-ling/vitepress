...
>
> #### （2） SUBSTRING：如果<span style = "color:red;font-weight:bold">不写结束位置</span>，默认是从开始位置<span style = "color:red;font-weight:bold">截取到</span>字符串<span style = "color:red;font-weight:bold">末尾</span>
>
