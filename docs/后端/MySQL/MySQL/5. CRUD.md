...
> #### SELECT 列名 <span style = "color:red">AS 别名</span> FROM 表名
>
...
>
> #### （4）若指定多列排序，则表示同时满足第一个条件的前提下，实现第二个条件排序
...
> #### <span style = "color:red;font-weight:bold">group by > having > order by > limit</span>
