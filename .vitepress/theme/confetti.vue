...
if (inBrowser) {
  ...
  // 新的粒子效果
  function startAdditionalConfettiEffect() {
  ...
  // 粒子效果
  function startAdditionalConfettiEffect_() {
...
// heart shape from https://thenounproject.com/icon/heart-1545381/
  ...
  // 根据当前主题启动相应的效果
  if (isDarkMode) {
    startSnowfall(); // 如果是暗模式，启动雪花效果
    // boom();
  } else {
    startFireworks(); // 如果是光模式，启动烟花效果
    // startAdditionalConfettiEffect(); // 额外的粒子效果
    // boom();
  }
}
</script>
